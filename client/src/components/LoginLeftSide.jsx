...
const LoginLeftSide = () => {
  return (
    <div className="hidden md:flex w-1/2 bg-indigo-950 relative overflow-hidden border-r border-slate-200">
        ...
        <div className="absolute -top-30 -left-30 w-72 h-72 bg-indigo-500/2 rounded-full blur-3xl">
        </div> 
        ...
        <div className="relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full">
            ...
            <p className="text-slate-400 text-lg max-w-md leading-relaxed">
                Joiye aa to full css and code copy karu chu but try karis k aa pati jase pachi bijo project jate banava
            </p>
