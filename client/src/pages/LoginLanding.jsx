    ...
    const portalOptions = [
        {
            to: "/login/admin",
            title: "Admin Portal",
            description: "Manage portals, departments, payroll, and system configuration.",
            icon: ShieldIcon
        },
        {
            to: "/login/employee",
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
            ...
            <div className="w-full max-w-md animate-fade-in relative z-10"> 
                ...
                <div className="mb-10 text-center md:text-left"> 
                    ...
                    <p className="text-slate-500">Select your role to login in into it.</p>
                </div>
                    ...
                    {portalOptions.map((portal)=> (
                        ...
                        className="group block bg-slate-50 border border-slate-200 rounded-lg p-5 sm:p-6 transition-all duration-300 hover:border-indigo-400 hover:bg-indigo-50">
                            ...
                            <div className=" relative z-10 flex items-center justify-between gap-4 sm:gap-5"> 
                                ...
                                <h3 className="text-slate-800 group-hover:text-indigo-600 mb-1 transition-colors">{portal.title} </h3>
